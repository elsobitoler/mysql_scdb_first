...
4. Удалите сущность actors из базы данных
5. Добавьте внешний ключ на атрибут genre_id сущности cinema и направьте его на атрибут id сущности genres.
6. Очистите сущность genres от данных и обнулить автоинкрементное поле.
